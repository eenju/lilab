...
def change(text):
    ...
    tmp=re.sub(pattern3,lambda m:'<sub>'+m.group(1)+'</sub>',tmp)
...
def main(origin,des):
    '''主函数，生成HTML'''
    category='<tr><th class="pubyear" id="idyear">yearcategory</th></tr>'
